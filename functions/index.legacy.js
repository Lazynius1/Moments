...
exports.onModerationReviewQueueCreated = onDocumentCreated(
  {
...
exports.onAppealCreatedTelegramAlert = onDocumentCreated(
  {
...
exports.moderateMediaContent = onRequest(
  {
    timeoutSeconds: 120,
    memory: '1GiB',
    secrets: [
...
exports.onFollowingRemoved = onDocumentDeleted('users/{userId}/following/{followingId}', async (event) => {
 ...
 */
exports.getStoryRingPage = onRequest(
  {
    timeoutSeconds: 30,
    memory: '512MiB',
    concurrency: 40
 ...
 */
exports.getAuthorStoryBundle = onRequest(
  {
    timeoutSeconds: 30,
    memory: '512MiB',
    concurrency: 80
