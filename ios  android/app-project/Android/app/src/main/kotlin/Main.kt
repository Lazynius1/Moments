...
internal val logger: SkipLogger = SkipLogger(subsystem = "moments.social", category = "MomentsSocial")

private typealias AppRootView = MomentsSocialRootView
private typealias AppDelegate = MomentsSocialAppDelegate
