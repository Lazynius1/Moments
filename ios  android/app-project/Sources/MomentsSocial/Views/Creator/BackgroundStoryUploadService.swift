...
class UploadingStory: ObservableObject, Identifiable {
    ...
    let createdAt: Date
    let finalRenderedImage: Any? // ✅ NUEVA: Imagen renderizada final para detectar aspect ratio (Android: Any instead of UIImage)
    ...
    @Published var thumbnailImage: Any? // Android: Any instead of UIImage
    ...
    init(
        ...
        finalRenderedImage: Any? = nil, // ✅ NUEVO: Parámetro opcional (Android: Any instead of UIImage)
...
class BackgroundStoryUploadService: ObservableObject {
    ...
    func uploadStory(
        ...
        customListId: String?,
        selectedListName: String?,
        finalRenderedImage: Any? = nil, // Para historias con overlays renderizados (Android: Any instead of UIImage)
        chainId: String? = nil, // 🔗 AÑADIDO: ID de la cadena
        chainPosition: Int? = nil, // 🔗 AÑADIDO: Posición en la cadena
        chainTitle: String? = nil, // 🔗 AÑADIDO: Título de la cadena
        allowOthersToContinue: Bool? = nil, // 🔗 AÑADIDO: Si otros pueden continuar la cadena
...
extension BackgroundStoryUploadService {
    ...
    private func optimizeImageForStory(_ image: Any) -> Any {
        // Android: Image optimization will be handled natively
        return image
        /*
        // iOS-specific image optimization code commented out for Android compatibility
    ...
    // Android: Image resizing will be handled natively
