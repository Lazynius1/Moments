...
struct AudienceSelectionView: View {
    ...
    @State var showingCustomSelector = false
    @State var showingCreateList = false
    @State var showingManageLists = false
    @State var customLists: [CustomAudienceList] = []
    @State var isLoadingLists = false
    @State var selectedUsersForCustom: [AppUser] = []
    @State var listToDelete: CustomAudienceList? // Add for deletion
    @State var showingDeleteAlert = false // Add for deletion alert
    @State var showingSaveFeedback = false // Para mostrar feedback de guardado
...
struct CustomAudienceList: Identifiable, Codable, Equatable {
    var id: String? // Changed from @DocumentID for Android compatibility
    let name: String
...
struct CustomAudienceListsView: View {
    @Environment(\.colorScheme) var colorScheme
    @Environment(\.dismiss) var dismiss
    @StateObject var viewModel = CustomAudienceListsViewModel()
    @State var showingCreateList = false
    @State var selectedList: CustomAudienceList?
    @State var showingDeleteAlert = false
    @State var listToDelete: CustomAudienceList?
...
struct CreateCustomListView: View {
    ...
    @State var selectedColor = CustomAudienceList.predefinedColors.first!
    @State var selectedIcon = CustomAudienceList.predefinedIcons.first!
    @State var selectedMembers: Set<String> = []
    @State var showingMemberPicker = false
...
struct EditCustomListView: View {
    ...
    @State var selectedMembers: Set<String>
    @State var showingMemberPicker = false
    @State var currentMembers: [AppUser] = []
    @State var isLoadingMembers = false
    @State var searchText = ""
    @State var filteredMembers: [AppUser] = []
...
struct MemberRowWithRemove: View {
    ...
    let user: AppUser
    let onRemove: () -> Void
    @State var showingRemoveAlert = false
