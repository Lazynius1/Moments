...
// Forward declaration - FeedViewModel is defined in FeedView.swift
// Android: Using weak reference to avoid circular dependencies
...
class BackgroundMomentUploadService: ObservableObject {
    ...
    weak var feedViewModel: AnyObject? // Android: Using AnyObject to avoid circular dependencies with FeedViewModel
    ...
    func uploadMoment(
        ...
        pauseListenersForUpload() // Call helper method instead
    ...
    private func processUpload(_ uploadingMoment: UploadingMoment) async {
        ...
        do {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + 1.0) {
                self.resumeListenersAfterUpload() // Call helper method instead
            }
    ...
    func setFeedViewModel(_ feedViewModel: AnyObject) {
        self.feedViewModel = feedViewModel
    }
    
    // Helper methods to call FeedViewModel methods safely
    private func pauseListenersForUpload() {
        // Android: FeedViewModel methods will be called through reflection or protocol
        // For now, this is a no-op that will be implemented natively
    }
    
    private func resumeListenersAfterUpload() {
        // Android: FeedViewModel methods will be called through reflection or protocol
        // For now, this is a no-op that will be implemented natively
    }
