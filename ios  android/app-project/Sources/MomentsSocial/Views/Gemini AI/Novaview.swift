...
struct GeminiView: View {
    ...
    @State var showSuggestedOptions = true
...
struct EnhancedGeminiHeader: View {
    ...
    @State var logoTapCount = 0
    @State var showDeveloperEasterEgg = false
    @State var lastTapTime = Date()
    @State var logoScale: CGFloat = 1.0
    @State var sparkleAnimation = false
...
class GeminiViewModel: ObservableObject {
    ...
    func detectInputLanguage(_ text: String) -> NovaLanguage? {
    ...
    func generateTempConversationId() -> String {
