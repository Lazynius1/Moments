...
struct SettingsView: View {
    ...
    @State var showMutualConnections: Bool = true
    @State var showFollowing: Bool = true
    @State var showAdmirers: Bool = true
    @State var isScheduleEnabled: Bool = false
    ...
    @State var isShowingContentVisibility: Bool = false
    @State var isShowingConnections: Bool = false
    @State var isShowingBestFriends: Bool = false
    @State var isShowingBlockedAccounts: Bool = false
    @State var isShowingMute: Bool = false
    @State var isShowingPasswordChange: Bool = false
    @State var isShowingLoginActivity: Bool = false
    @State var isShowingSavedMoments: Bool = false
    @State var isShowingUserActivity: Bool = false
    @State var isShowingDataExport: Bool = false
    @State var isShowingArchivedStories: Bool = false
    @State var isShowingHighlightedStories: Bool = false
    @State var isShowingSupportMoments: Bool = false
    @State var isShowingNotificationSettings: Bool = false
    @State var isShowingAdvancedAccountManagement: Bool = false
