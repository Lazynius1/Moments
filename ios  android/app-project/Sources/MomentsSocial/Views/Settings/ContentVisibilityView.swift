...
struct ContentVisibilityView: View {
    ...
    @StateObject var viewModel = ContentVisibilityViewModel()
    @State var isLoading = true
    @State var showingStoryAudienceSelector = false
    @State var showingPostAudienceSelector = false
    @State var showingStoryInteractionSettings = false // ✅ NUEVO
