...
struct AccountManagementSection: View {
    ...
    @State var showDeactivateConfirmation = false
    @State var showDeleteConfirmation = false
    @State var showDeleteVerification = false
...
struct DeleteAccountVerificationView: View {
    ...
    @State var agreeToDelete: Bool = false
    @FocusState var isPasswordFocused: Bool
    @FocusState var isConfirmFocused: Bool
