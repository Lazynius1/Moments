...
struct StoriesView: View {
    ...
    @State var otherUsersStoryCount: Int = 0
    @State var adStoryCount: Int = 1
    @State var adStoryIndex: Int = 0
    @State var totalStoriesViewed: Int = 0
    
    // 🔗 STORY CHAINS: Variables para navegación entre partes
    @State var chainStories: [Story] = []
    @State var currentChainIndex: Int = 0
    @State var isInChainMode: Bool = false
