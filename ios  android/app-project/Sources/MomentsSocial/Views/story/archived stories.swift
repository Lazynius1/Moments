...
struct ArchiveView: View {
    ...
    @State var showStoryViewer = false
    @State var showStoryStats = false
    @State var viewMode: ArchiveViewMode = .vertical
...
struct SingleStoryViewer: View {
    ...
    @State var loadingText: String = "Preparando historia..."
...
struct StoryStatsView: View {
    ...
    @Environment(\.dismiss) var dismiss
    @Environment(\.colorScheme) var colorScheme
    @StateObject var viewModel = StoryStatsViewModel()
...
struct ReactionRow: View {
    ...
    @Environment(\.colorScheme) var colorScheme
    @State var username: String = NSLocalizedString("archivedStories.user", comment: "User")
