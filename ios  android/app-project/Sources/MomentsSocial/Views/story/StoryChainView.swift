...
struct StoryChainView: View {
    ...
    @StateObject var viewModel = StoryChainViewModel()
    @State var selectedStoryIndex = 0
    @State var chainStats: (partCount: Int, remainingTime: TimeInterval, isExpired: Bool) = (0, 0, false)
    @State var showLimitAlert = false
    @State var limitAlertMessage = ""
    @State var showStoriesViewer = false
