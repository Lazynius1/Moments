...
struct QuestionResponsesView: View {
    ...
    @State var responses: [QuestionResponse] = []
    @State var isLoading = true
    @State var showingShareSheet = false
    @State var selectedResponse: QuestionResponse?
...
struct QuestionResponseRow: View {
    ...
    @State var responderUsername: String = ""
    @State var showingResponderProfile = false
...
struct ShareResponseView: View {
    ...
    @State var showingCreatorView = false
...
struct CreatorViewWithResponseData: View {
    ...
    @Environment(\.dismiss) var dismiss
    @State var isCreatingStory: Bool = true
    @State var showCreatorView: Bool = true
