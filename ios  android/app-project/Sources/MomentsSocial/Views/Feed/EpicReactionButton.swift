...
struct EpicReactionButton: View {
    ...
    @State var reactionListener: ListenerRegistration?
    ...
    @State var showReactionsSheet = false
...
struct EpicReactionPickerView: View {
    ...
    let onClose: () -> Void
    @State var appearScale: [CGFloat] = Array(repeating: 0.3, count: 16) // Actualizado para 16 reacciones
    
    @StateObject var usageTracker: UserReactionUsageTracker
...
struct ReactionsListSheet: View {
    ...
    @State var reactions: [String: [String]] = [:]
    @State var userProfiles: [String: AppUser] = [:]
    @State var isLoading = true
    @State var followStates: [String: Bool] = [:] // Estado de seguir para cada usuario
    @State var followLoadingStates: [String: Bool] = [:] // Estados de carga para seguir
