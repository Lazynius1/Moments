...
class GlobalVideoManager: ObservableObject {
    ...
    @Published(set) var activeVideoId: String?
...
struct ModernVideoPlayer: View {
    ...
    @StateObject var globalManager = GlobalVideoManager.shared
    @State var showControls = false
    @State var showMuteButton = true
    @State var progress: Double = 0
    @State var isBuffering = false
    @State var hasSetupPlayer = false
