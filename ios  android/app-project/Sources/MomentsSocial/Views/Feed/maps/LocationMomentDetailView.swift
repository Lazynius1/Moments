...
struct LocationMomentDetailView: View {
    ...
    @State var commentCounts: [String: Int] = [:]
    @State var savedStates: [String: Bool] = [:]
    @State var loadingStates: [String: Bool] = [:]
    
    // ✅ NUEVOS: Estados para menú contextual
    @State var showContextMenu = false
    @State var contextMenuMoment: Moment?
    ...
    private var locationMomentContentText: some View {
        VStack(alignment: .leading, spacing: 12) {
            Text(moment.content)
                ...
                .foregroundColor(colorScheme == ColorScheme.dark ? .white.opacity(0.9) : .black.opacity(0.9))
...
struct LocationMomentContextMenu: View {
    ...
    private func shareLocationMoment() {
        // Android: Share functionality will be handled natively
        // let items: [Any] = [
        ...
        // Android: Share will be implemented natively
    }
}
