...
struct TrendingView: View {
    ...
    @StateObject var trendingService = TrendingService.shared
    @State var trendingContent: TrendingService.PersonalizedTrendingContent?
    ...
    @State var showExploreWithLocation = false
