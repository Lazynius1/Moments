...
struct GridPhotoPickerView: View {
    ...
    @State var selectedCategory: PhotoCategory = .recent
    
    // NUEVO: Estados para el editor de crop
    @State var isShowingCropEditor = false
    @State var selectedAssetForCrop: PHAsset? // Cambio: pasamos el asset
    
    // Estados para upload
    @State var isUploading = false
    @State var uploadError: String?
    @State var showUploadError = false
...
struct ModernEditProfileView: View {
    ...
    @State var currentProfileImage: UIImage?
    @State var isShowingInterestsPicker: Bool = false
    @State var showingDeleteConfirmation: Bool = false
    @State var activeSection: EditSection = .basic
    ...
    private func saveProfile() {
        ...
        saveGroup.notify(queue: DispatchQueue.main) {
            self.isLoading = false
