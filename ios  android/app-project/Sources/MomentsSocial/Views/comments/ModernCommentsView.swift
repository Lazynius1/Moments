...
struct ModernCommentsView: View {
    ...
    @State var editingCommentId: String? = nil
    @State var editingCommentContent: String = ""
    @State var replyToComment: Comment? = nil
    @State var showDeleteAlert = false
    @State var commentToDelete: Comment? = nil
    @State var expandedComments: Set<String> = []
    @State var sortOption: CommentSortOption = .newest
    @State var isLoading = true
    @State var commentsListener: ListenerRegistration?
